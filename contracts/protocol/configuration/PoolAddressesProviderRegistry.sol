 ...
 * @author Peko
 * @notice Main registry of PoolAddressesProvider of Peko markets.
 * @dev Used for indexing purposes of Peko protocol's markets. The id assigned to a PoolAddressesProvider refers to the
 * market it is connected with, for example with `1` for the Peko main market and `2` for the next created.
 */
